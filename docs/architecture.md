...
Recipe extraction now follows [ADR 0009](decisions/0009-jev-recipe-parsing.md): classify source text with Jev, preserve exact quantity spans and ingredient alternatives, and publish reviewable drafts. Worker setup changes require a restart or container rebuild before the new parser is live.
